...
import kotlinx.android.synthetic.main.activity_sign_up_other.email_signup_other
import kotlinx.android.synthetic.main.activity_sign_up_other.login_btn_other
import kotlinx.android.synthetic.main.activity_sign_up_other.pass_rec
...
class SignUp_other : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editText = findViewById(R.id.id_signup_other)
        editText2 = findViewById(R.id.email_signup_other)
        editText3 = findViewById(R.id.pass_rec)
        ...
        button2.setOnClickListener {
            ...
            val input =email_signup_other.text
            val userInputpass = pass_rec.text
                    ...
                    try{
                        ...
                        sendPostRequest(url, requestBody) { responseString ->
                            ...
                            if(responseString=="created!"){
                                intent= Intent(this,LightingControl::class.java)
        ...
        login_btn_other.setOnClickListener {
